...
//            tv_store_name_right = itemView.findViewById(R.id.tv_store_name_right);
    ...
    public void setImg_merchant_two(Merchant merchantleft , Merchant merchantright) {
        ...
        Glide.with(BusinessProductMerchantFragment.getInstance()).load(SmileApplication.DOMAIN + merchantleft.getPicture_url()).into(img_merchant_left);
        Glide.with(BusinessProductMerchantFragment.getInstance()).load(SmileApplication.DOMAIN + merchantright.getPicture_url()).into(img_merchant_right);
    ...
    public void setImg_product_two(Product productleft , Product productright) {
        ...
        img_merchant_right.setVisibility(View.INVISIBLE);
        Glide.with(BusinessProductMerchantFragment.getInstance()).load(SmileApplication.DOMAIN + productleft.getPicture_url()).into(img_product_left);
        Glide.with(BusinessProductMerchantFragment.getInstance()).load(SmileApplication.DOMAIN + productright.getPicture_url()).into(img_product_right);
