...
import com.lafresh.smile2.Business.Adapter.BusinessProductListAdapter;
import com.lafresh.smile2.Business.Contract.BusinessProductContract;
import com.lafresh.smile2.Business.Presenter.BusinessProductPresenter;
...
public class BusinessProductFragment extends BaseFragment implements BusinessProductContract.View{
    ...
    public static BusinessProductFragment getInstance(int store_id) {
        if (fragment == null) {
    ...
    public static BusinessProductFragment getInstance(int store_id , String business_sale_id) {
        if (fragment == null) {
            fragment = new BusinessProductFragment();
        }
        Bundle bundle = new Bundle();
    ...
    private void initView(View view) {
        ...
        Log.e(TAG,"store_id : " + store_id + "business_sale_id : " + business_sale_id);
    ...
    public void setProductTypeList(List<ProductType> productTypeList) {
        ...
        //
        productPresenter.getProductList(sort , Integer.toString(store_id) , "" , "" , business_sale_id);
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.BaseOnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                productPresenter.getProductList(sort , Integer.toString(store_id) , type_id , "" , business_sale_id);
    ...
    public void goPageProductDetail(int product_id) {
        ((MainActivity) getActivity()).addFragment(BusinessProductDetailFragment.getInstance(product_id , business_sale_id));
    }
