...
//    public ImageView img_merchant_left , img_merchant_right;
    ...
    public void setImg_product_two(Product productleft , Product productright) {
        ...
        Glide.with(BusinessProductFragment.getInstance()).load(SmileApplication.DOMAIN + productleft.getPicture_url()).into(img_product_left);
        Glide.with(BusinessProductFragment.getInstance()).load(SmileApplication.DOMAIN + productright.getPicture_url()).into(img_product_right);
