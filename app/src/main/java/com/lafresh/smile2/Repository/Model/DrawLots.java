...
public class DrawLots implements Parcelable {
    ...
    private String receipt_required = "";
    private String member_group_required = "";
    ...
    public String getReceipt_required(){
        return receipt_required;
    }

    public String getMember_group_required(){
        return member_group_required;
    }
