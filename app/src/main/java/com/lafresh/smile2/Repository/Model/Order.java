...
public class Order implements Parcelable {
    ...
    public static String getOrderStatusByType(int status) {
        switch (status) {
            case 1:
                return SmileApplication.getInstance().getString(R.string.order_waiting_ship);
            case 2:
            case 4:
            case 5:
                return SmileApplication.getInstance().getString(R.string.order_finish_api);
            case 3:
                return SmileApplication.getInstance().getString(R.string.order_cancel);
            case 6:
                return SmileApplication.getInstance().getString(R.string.order_return_finish);
            case 7:
                return SmileApplication.getInstance().getString(R.string.order_exchange_finish);
            case 0:
            default:
                return SmileApplication.getInstance().getString(R.string.order_waiting_pay);
        }
    }
